...
public:
	...
	int getLightColor(BlockPos const&);
	bool isSolidRender(Block const&);
	bool isTranslucent(Block const&);
	int _getBlockColor(BlockPos const&, Block const&);
	int _getBlockColor(BlockPos const&, Block const&, unsigned char);
	...
	bool tessellateInWorld(Block const&, BlockPos const&, unsigned char, TextureUVCoordinateSet const&);
	bool tessellateInWorld(Block const&, BlockPos const&, unsigned char, bool);
	...
	BlockSource& getRegion() const;
		...
		int ID1(const BlockPos&);
	int DATA1(const BlockPos&);
	
	int ID2(const BlockPos&);
	int DATA2(const BlockPos&);
	
	int ID3(const BlockPos&);
	int DATA3(const BlockPos&);
	
	int ID4(const BlockPos&);
	int DATA4(const BlockPos&);
	
	int ID5(const BlockPos&);
	int DATA5(const BlockPos&);
	
	int ID6(const BlockPos&);
	int DATA6(const BlockPos&);
	
	bool AluminumWire(Block const&, const BlockPos&, unsigned char, bool);
	bool NASAWorkBench(Block const&, const BlockPos&, unsigned char, bool);
	
	void xxx(float,float,float,float,float,float,float,float,float,float,TextureUVCoordinateSet,const BlockPos&);
	void xxxx(float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,float,TextureUVCoordinateSet,const BlockPos&);
public:
